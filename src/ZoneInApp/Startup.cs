...
namespace ZoneInApp
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            SampleDataReco.Initialize(app.ApplicationServices);
            SampleEvents.Initialize(app.ApplicationServices);
            SamplePosts.Initialize(app.ApplicationServices);
            SampleInbox.Initialize(app.ApplicationServices);
        }
    }
}
